...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        UserRole.withNewTransaction {
            ...
            final User staff = User.findOrSaveWhere(username: 'DFGR', password: '3GD')
            UserRole.findOrSaveWhere(user: staff, role: staffRole)
            final User uploader = User.findOrSaveWhere(username: 'ZUD6', password: 'PAS')
            UserRole.findOrSaveWhere(user: uploader, role: uploaderRole)
